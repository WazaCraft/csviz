...
# Main Execution
st.title('CSViz: A Dynamic Data Dashboard')
...
if df is not None:
    ...
    # Create Tabs
    tab1, tab2, tab3, tab4 = st.tabs(["Summary", "Numeric Data", "Categorical Data", "Geographic Data"])
    ...
    with tab1:
        ...
        with st.expander("Edit Mode", expanded=False):
            ...
            if edited_df is not None:
                st.write("Here's the edited data:")
                st.write(edited_df)
    ...
    # Geographic Data Tab
    with tab4:
        # Assuming the `generate_geographic_data` function is properly defined to handle Geographic Data
        generate_geographic_data(df)
